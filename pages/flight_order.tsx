...
const CreateOrderPage = () => {
  ...
  const createOrder = async () => {
    try {
      ...
      const apiKey = 'ghmvR1k7tYFi4dHJKoT29GDOqCRYBk8j';
      
      // Replace 'YOUR_ORIGIN' and 'YOUR_DESTINATION' with actual airport codes
      const origin = 'SYD';
      ...
      let access_token_response = amadeusApi1.data.access_token;
                    ...
                    "segments": [
                      {
                        "departure": {
                          "iataCode": "MAD",
                          "terminal": "2",
                          "at": "2024-03-05T20:25:00"
                        },
                        "arrival": {
                          "iataCode": "AMS",
                          "at": "2024-03-05T23:00:00"
                        },
                        "carrierCode": "KL",
                        "number": "1706",
                        "aircraft": {
                      ...
                      },
                      {
                        "departure": {
                          "iataCode": "AMS",
                          "at": "2024-03-06T10:40:00"
                        },
                        "arrival": {
                          "iataCode": "GIG",
                          "terminal": "2",
                          "at": "2024-03-06T18:35:00"
                        },
                        "carrierCode": "KL",
                        "number": "705",
                        "aircraft": {
  ...
  return (
    <div>
      ...
      {orderId && <p>Order created successfully! Order ID: {orderId}</p>}
    </div>
  );
};
